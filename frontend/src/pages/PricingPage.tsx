      ...
      <div className="mt-8 grid gap-6 md:grid-cols-2">
        <div className="glass-panel flex flex-col p-5">
          ...
          <ul className="mt-4 flex-1 space-y-2 text-xs text-slate-300">
            <li>• 3 daily voice sessions</li>
            <li>• Basic memory timeline</li>
            <li>• Weekly summary preview</li>
          </ul>
          <button
            onClick={() => navigate("/signup")}
            className="mt-6 rounded-full border border-slate-600 px-4 py-2 text-xs font-semibold text-slate-100 hover:border-cyan-400 hover:text-cyan-200"
          >
            Get started
          </button>
        </div>
        ...
        <div className="glass-panel flex flex-col border border-cyan-400/50 bg-slate-900/80 p-5">
          ...
          <button
            ...
            className="mt-6 rounded-full bg-cyan-400 px-4 py-2 text-xs font-semibold text-slate-950 shadow-lg shadow-cyan-500/40 hover:bg-cyan-300 disabled:opacity-50"
          >
